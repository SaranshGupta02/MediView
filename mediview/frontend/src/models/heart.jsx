...
const inputFields = [
  ...
  { name: "sex", type: "dropdown" },
  { name: "cp", type: "dropdown" },                  // Chest Pain Type
  { name: "trestbps", type: "number" },              // Resting BP
  { name: "chol", type: "number" },                  // Cholesterol
  { name: "fbs", type: "dropdown" },                 // Fasting Blood Sugar
  { name: "restecg", type: "dropdown" },             // ECG results
  { name: "thalach", type: "number" },               // Max Heart Rate
  { name: "exang", type: "dropdown" },               // Exercise Induced Angina
  { name: "oldpeak", type: "number" },               // ST Depression
  { name: "slope", type: "dropdown" },               // Slope of ST segment
  { name: "ca", type: "number" },                    // No. of vessels colored
  { name: "thal", type: "dropdown" },                // Thalassemia type
];
...
export const HeartDiseaseDetector = () => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Fill in medical details to detect heart disease.
          </p>
        </div>
