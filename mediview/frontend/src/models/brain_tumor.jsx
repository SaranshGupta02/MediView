...
export const BrainTumorDetector = () => {
 ...
 const { token, setToken} = useContext(AppContext)
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/predict_brain_tumor', formData, {
        headers: {
  ...
  console.log('Test result saved:', saveResponse.data);
      ...
      if (results && resultStatus && confidence) {
        ...
        if (data.result.prediction.toLowerCase().includes('negative')) {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800">Brain Tumor Detection</h1>
            </div>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Upload your brain scan image and get instant AI-powered tumor detection results with advanced medical imaging analysis.
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-primary-400 transition-colors duration-300 mb-6">
                ...
                <label htmlFor="imageUpload" className="cursor-pointer">
                  <div id="uploadText">
                    <p className="text-lg text-gray-600 mb-2">Click to upload brain scan image</p>
