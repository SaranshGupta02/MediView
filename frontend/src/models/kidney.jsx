...
const inputFields = [
  ...
  { name: "Red_blood_cells", type: "dropdown" },
  { name: "Pus_cell", type: "dropdown" },
  { name: "Pus_cell_clumps", type: "dropdown" },
  { name: "Bacteria", type: "dropdown" },
  ...
  { name: "Haemoglobin", type: "number" },
  { name: "Packed_cell_volume", type: "number" },
  { name: "White_blood_cell_count", type: "number" },
  { name: "Red_blood_cell_count", type: "number" },
  { name: "Hypertension", type: "dropdown" },
  { name: "Diabetes_mellitus", type: "dropdown" },
  { name: "Coronary_artery_disease", type: "dropdown" },
  { name: "Appetite", type: "dropdown" },
  { name: "Peda_edema", type: "dropdown" },
  { name: "Aanemia", type: "dropdown" },
];
...
export const KidneyDiseaseDetector = () => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Fill in medical details to detect Kindney Disease.
          </p>
        </div>
